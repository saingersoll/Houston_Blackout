...
# identifying homes boardering the buffer and beyond
hb_boundary_plus <- st_within(cropped_houston_blackout, highway_buffer)
```
...
blackout_buildings <- buildings[hb_boundary_plus, .pred = st_intersects]

blackout_homes <- nrow(blackout_buildings)
```
