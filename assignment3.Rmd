...
```{r}
VIIRS_05_07 <- st_read("../data/data-3/VNP46A1/._VNP46A1.A2021038.h08v05.001.2021039064328")

VIIRS_06_07 <- st_read("../data/data-3/VNP46A1/._VNP46A1.A2021038.h08v05.001.2021039064328")

VIIRS_05_16 <- st_read("../data/data-3/VNP46A1/._VNP46A1.A2021038.h08v05.001.2021039064328")

VIIRS_06_16 <- st_read("../data/data-3/VNP46A1/._VNP46A1.A2021038.h08v05.001.2021039064328")
```

### Reading in Road Data

```{r}
roads <- st_read("../data/data-3/gis_osm_roads_free_1.gpkg/gis_osm_roads_free_1.gpkg")
```

### Reading in House Data

```{r}
houses <- st_read("../data/data-3/gis_osm_buildings_a_free_1.gpkg/gis_osm_buildings_a_free_1.gpkg")
```
...
```{r}
rootdir <- ("~1/EDS223")
datadir <- file.path(rootdir,"data","data-3")
