...
```{r}
VIIRS_05_07 <- read_stars("data/VNP46A1/VNP46A1/VNP46A1.A2021038.h08v05.001.2021039064328.tif")

VIIRS_06_07 <- read_stars("data/VNP46A1/VNP46A1/VNP46A1.A2021038.h08v06.001.2021039064329.tif")

VIIRS_05_16 <- read_stars("data/VNP46A1/VNP46A1/VNP46A1.A2021047.h08v05.001.2021048091106.tif")

VIIRS_06_16 <- read_stars("data/VNP46A1/VNP46A1/VNP46A1.A2021047.h08v06.001.2021048091105.tif")
```

### Reading in Road Data with sf

```{r}
roads <- st_read("data/gis_osm_roads_free_1.gpkg/gis_osm_roads_free_1.gpkg")
```

### Reading in House Data with sf
...
Q: the files I downloaded from the README don't have the same file names for socioeco
...
```{r}
socioeconomic = st_read("C:/1/EDS223/assignment-3-saingersoll/data/ACS_2019_5YR_TRACT_48.gdb", layer = "ACS_2019_5YR_TRACT_48")
```

```{r}
socioeconomic = st_read("data/ACS_2019_5YR_TRACT_48.gdb", layer = "ACS_2019_5YR_TRACT_48")
```
...
```{r}
socioeconomic = st_read(here("data/ACS_2019_5YR_TRACT_48.gdb", layer = "ACS_2019_5YR_TRACT_48"))
```
